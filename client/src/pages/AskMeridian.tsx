  ...
  return (
    <div className="h-full flex flex-col items-center justify-center p-6">
      ...
      >
        ...
        <h1 className="font-display text-2xl font-bold mb-2">Ask Meridian</h1>
        <p className="text-muted-foreground text-sm mb-8">
          Your AI sales intelligence assistant. Ask about deals, stakeholders, risks, or strategy.
        </p>
          ...
          <input
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter' && query.trim()) {
                toast('AI assistant coming soon — this feature requires backend integration.');
                setQuery('');
              }
            }}
          />
